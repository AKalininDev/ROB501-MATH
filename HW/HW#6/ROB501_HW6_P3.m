...
load('DataHW06_Prob3.mat'); % Loads t, y, dy
window_size = 15;
...
RMSE_regression = computeRMSE(dy(window_size:end), y_derivative');
RMSE_naive = computeRMSE(dy(window_size:end), y_naive');

%% Plot the Results

figure('Position', [100, 100, 1600, 900]);
sgtitle('Figure 2. Problem 3, Comparing dy/dt Estimation Techniques',...
...
estimated_der_name = "Regression (15 points) dy/dt Estimation. (Part B)";
...
% Save the figure
print('ROB501-HW6-P3-Derivatives.png', '-dpng', '-r300');
